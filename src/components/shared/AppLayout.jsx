      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'auto' }}>
        ...
        <header style={{
          ...
          <div style={{
            ...
            <input
              ...
              style={{
                ...
                color: '#999', fontSize: '13px', width: '100%',
          ...
          <button style={{
            ...
            padding: '8px', cursor: 'pointer', color: '#888',
          }}>
            <Bell size={16} />
            <span style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: '#E8700A', fontWeight: 700, fontSize: '11px',
            }}>
              {profile?.first_name?.[0]}{profile?.last_name?.[0] || 'MM'}
            </div>
            <div>
              <div style={{ color: '#DDD', fontSize: '12px', fontWeight: 600 }}>
                {profile?.first_name || 'Madembe'} {profile?.last_name || 'Maano'}
              </div>
